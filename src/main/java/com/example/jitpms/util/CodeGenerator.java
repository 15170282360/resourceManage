...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/jitpms2?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true");
        ...
        pc.setMapper("dao");
        pc.setParent("com.example.jitpms");
...
//        strategy.setControllerMappingHyphenStyle(true);
        ...
        //指定某张表生成代码
        strategy.setInclude("status_resource");
